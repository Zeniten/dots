...
before packages are loaded."
  ...
  (with-eval-after-load 'org
    ...
    ;;; GTD
    (setq org-agenda-files '("~/Dropbox/org/tasks/inbox.org"
                            "~/Dropbox/org/tasks/todo.org"
                            ;; "~/Dropbox/org/tasks/tickler.org"
                            ))

    (setq org-capture-templates '(("i" "Inbox" entry
                                   (file "~/Dropbox/org/tasks/inbox.org")
                                   "* %i%?")
                                  ;; ("s" "Shopping List" checkitem
                                  ;;  (file+headline "~/Documents/Sync/shopping-list.org" "Groceries [/]")
                                  ;;  "- [ ] %i%?")
                                  ("t" "Tasks" entry
                                   (file+headline "~/Dropbox/org/tasks/todo.org" "Tasks")
                                   "* %i%?")
                                  ;; ("T" "Tickler" entry
                                  ;;  (file+headline "~/Dropbox/org/tasks/tickler.org" "Tickler")
                                  ;;  "* %i%? \n %U")
                                  ;; ("Q" "Question" entry
                                  ;;  (file+headline "~/Dropbox/org/tasks/questions.org" "Unanswered Questions")
                                  ;;  "* %i%?")
                                  ))

    (setq org-refile-targets '(("~/Dropbox/org/tasks/todo.org" :maxlevel . 2)
                               ;; ("~/Dropbox/org/tasks/someday.org" :level . 1)
                               ;; ("~/Dropbox/org/tasks/tickler.org" :maxlevel . 2)
                               ))

    (setq org-todo-keywords '((sequence "TODO(t)" "STARTED(s)" "WAIT(w)" "|" "DONE(d)")))

    ;;; org-journal
    (setq org-journal-dir "~/Dropbox/org/journal") ;; change this to make another journal
